...
type PageState = "form" | "pending-verification";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setPageState("pending-verification");
    } catch {
  ...
  // Single root element — never unmounts, prevents removeChild crash
  // caused by browser extensions injecting nodes into password inputs.
  return (
    <div>
      {pageState === "pending-verification" ? (
